...
public class AmazonSES {
    ...
    //Class copied from source code provided by instructor

    // This address must be verified with Amazon SES.
    final String FROM = "andressalazarcolina@gmail.com";
    ...
    final String HTMLBODY = "<h1>Please verify your email address</h1>"
            ...
            + "<a href='http://localhost:8080/SpringBoot-Verification-Project/email-verification.html?token=$tokenValue'>"
    ...
    final String TEXTBODY = "Please verify your email address. "
            ...
            + " http://http://localhost:8080/SpringBoot-Verification-Project/email-verification.html?token=$tokenValue"
            + " Thank you! And we are waiting for you inside!";
